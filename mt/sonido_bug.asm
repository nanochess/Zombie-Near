...
tabla_vol:
        db $ff,$ff,$ff,$fe,$fe,$fe,$fd,$fb,$fa,$f8,$f7,$f5,$f4,$f3,$f1,$f0
    endif
...
.3:     or $d0
        ...
        call conv_vol
        ld (ef_envm),a
        ld hl,(ef_envo) ; Frecuencia que debe dividir por 15 (longitud bits)
        ld d,h          ; (nota: s¢lo vale para el SN76489 original)
        ld e,l          ; Otros como el Sega Master System usan 16 bits.
