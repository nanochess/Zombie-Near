        ...
        ; $00000 - C¢digo y datos b sicos               1.25K
        ; $06000 - Retratos (1K cada uno)                 -
        ; $07c00 - Tabla aleatoria                        -
        ; $08000 - Retratos                               -
        ; $09800 - Libres                               2.00K
...
inicio:
    ...
    if 0
        ; Para comprobar idioma alternativo
        ld a,1
        ld (idioma),a
    endif
        ;
