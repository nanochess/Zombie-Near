        ...
        ;                        Admite ritmos variables.
        ; Revisi¢n: 01-abr-2011. Correcci¢n al reiniciar mezclador de sonido,
        ;                        quedaba mal al cambiar de melod¡a con ritmo
        ;                        a melod¡a de acordes.
        ; Revisi¢n: 02-abr-2011. Experimento de bajo distorsionado al pelear
        ;                        con jefe.
        ; Revisi¢n: 03-abr-2011. Mejora en genera_sonido para que el sonido
        ;                        se cambie con exactitud. El efecto de sonido
        ;                        de monstruo ya no interfiere con el del
        ;                        megamonstruo (ocurr¡a si se mataba el mega
        ;                        y luego el mini, sonaba como basura).
        ; Revisi¢n: 04-abr-2011. M s optimizaci¢n y se solucion¢ un defecto
        ;                        en el bajo para las melod¡as principales,
        ;                        siempre le bajaba tres octavas y no hac¡a el
        ;                        efecto de dos octavas, ahora se escucha
        ;                        bastante mejor. Al perder una vida suena m s
        ;                        agudo para la chica. Las melod¡as de tema
        ;                        son alternadas entre dos instrumentos, el
        ;                        original y piano, as¡ se hacen menos
        ;                        repetitivas y se agrega instrumento_piano.
        ; Revisi¢n: 05-abr-2011. Se corrige un peque¤o defecto en
        ;                        genera_pierde, no copiaba A en E antes de
        ;                        sumar.
        ; Revisi¢n: 08-abr-2011. Nuevas funciones efecto_laser y genera_laser
        ; Revisi¢n: 09-abr-2011. Nueva funci¢n efecto_rasca.
        ; Revisi¢n: 29-dic-2011. Peque¤a mejora para compatibilidad con
        ;                        varios ensambladores "sub a," -> "sub ".
        ;
...
musica_historia:
        push hl
        ld hl,$1078             ; Duraci¢n envolvente para piano
        ld (ef_envo),hl
        xor a                   ; Forma de onda: \___
        ld (ef_envm),a
...
musica_amor:
        push hl
        ld hl,$1478             ; Duraci¢n envolvente para piano
        ld (ef_envo),hl
        xor a                   ; Forma de onda: \___
        ld (ef_envm),a
        ld hl,melodia_amor
...
instrumento_flauta_pan:
        ...
        add hl,de
        ld a,c
        sub flauta_pan_vibrato and 255
        rrca
        jr nc,.1
        add hl,hl
.1:     rlca
...
.0:     ld e,(hl)
        ...
        ; volumen a 0 y dejarlo activado.
        ;
        ld a,(ef_mezc)
        and $c0                 
        or $38
