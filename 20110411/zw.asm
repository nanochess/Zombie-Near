        ...
        ; 2, 3, 4 y 5), se desactiva el logo del distribuidor para que
        ; quepan en la ROM.
        ;
PROGRAMADOR:    EQU 0
...
LINEAR: EQU 1
        ...
        ;
        ; Total libre: 60 bytes de 64K (0.09% libre)
        ;
...
GRAFICA_COPYRIGHT:      ; El copyright
    ...
    ENDIF
        ...
        ;   ddmmaa
        DB "080411"     ; Reservado por MSX, aprovecho para la revisi¢n

        DB "ZOMBIE NEAR "
        DB "(c)2011 Oscar Toledo Gutierrez. "
        DB "nanochess.110mb.com",0        
...
.3:
        ...
        DEC C                   ; 5
        NOP                     ; 5
        DJNZ .3                 ; 14 = 32 ciclos antes de OUT
        INC DE
...
.16:    ld hl,puntos_cero
        ld (salva_puntos),hl
        cp 11                   ; ¨Vida?
        ld a,6                  ; Nube de sangre
        jr nz,.9
        ld a,11                 ; Nube dorada para vida
.9:     ld (iy+d_color),a
        call bala_explota2
        pop hl
        pop iy
...
;        include "graficas.asm"
        ...
        ; Unos pocos mensajes que no cab¡an en otra parte
...
mensaje_12:     ; DISTRIBUTED BY
    ...
    if programador=0
logo_distribuidor:    
        db $f6,$00,$fd,$01,$fd,$03,$0b,$07
        db $0f,$0f,$80,$c0,$c0,$e0,$e0,$f0
        db $f8,$f8,$f7,$00,$10,$01,$03,$03
        db $07,$07,$0f,$1f,$1f,$00,$80,$80
        db $c0,$c0,$e0,$f0,$F0,$f7,$00,$f7
        db $00,$0b,$1f,$0f,$0f,$07,$07,$03
        db $03,$01,$fc,$fe,$fe,$fa,$ff,$fa
        db $00,$06,$81,$c3,$c3,$3f,$7f,$7f
        db $fa,$ff,$08,$f8,$f0,$F0,$e0,$e0
        db $c0,$c0,$80,$f7,$00,$fd,$00,$fd
        db $07,$fd,$0f,$fd,$1f,$02,$01,$00
        db $f1,$ff,$fd,$e7,$fd,$ff,$04,$e7
        db $c3,$81,$81,$f7,$ff,$02,$80,$00
        db $f9,$ff,$fd,$00,$fd,$e0,$fd,$f0
        db $fd,$f8,$fd,$3f,$fd,$7f,$fb,$00
        db $fb,$ff,$fb,$00,$08,$ff,$fe,$fe
        db $ff,$0f,$0f,$1f,$1f,$fc,$00,$f9
        db $ff,$fd,$7f,$05,$ff,$f0,$f0,$f8
        db $f8,$fb,$ff,$fb,$00,$fd,$fc,$fd
        db $fe,$fb,$00,$f2,$00,$fd,$01,$05
        db $03,$3f,$3f,$7f,$7f,$f5,$ff,$06
        db $e7,$c3,$fc,$fc,$fe,$fe,$fb,$ff
        db $fa,$00,$fd,$80,$01,$c0,$f7,$00
        db $f7,$00,$08,$03,$07,$07,$0f,$0f
        db $1f,$00,$00,$fa,$ff,$06,$fe,$00
        db $00,$c3,$81,$81,$fa,$00,$fa,$ff
        db $09,$7f,$00,$00,$c0,$e0,$e0,$f0
        db $f0,$f8,$f5,$00,$1a,$00,$18,$3c
        db $36,$36,$33,$33,$31,$00,$19,$3c
        db $6c,$6d,$cd,$cd,$8d,$00,$fe,$07
        db $03,$ff,$83,$83,$ff,$00,$7d,$f9
        db $0d,$05,$00,$f7,$80,$80,$87,$fc
        db $86,$10,$00,$fb,$18,$18,$fb,$33
        db $1b,$0d,$00,$fc,$0e,$06,$fe,$06
        db $06,$fe,$d7,$00,$02,$06,$03,$f1
        db $00,$c7,$81,$c7,$81,$c7,$81,$c7
        db $81,$c7,$81,$c7,$81,$c7,$f1,$c7
        db $f1
    endif
