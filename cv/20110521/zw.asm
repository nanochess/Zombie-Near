        ...
        ;                        sonido antes de tener lista la m£sica en la
        ;                        VRAM, as¡ que pod¡a sonar un tono raro.
        ;
...
PROGRAMADOR:    EQU 0
        ...
        ;
        ; Mapa de uso del ROM:
        ; $8000-$FFFF - Programa, mapas, gr ficas y sonido
        ;
...
colores_pantalla_pc:
    ...
    if programador=1
        DB 255 and ($f5+$fd+$35+$07) 
    else
        DB $6a          ; Byte para ajustar el resultado del checksum a cero
    endif
...
ef_ruido:       RB 1    ; Ruido
ef_rp:          RB 1    ; Valor previo de ruido
