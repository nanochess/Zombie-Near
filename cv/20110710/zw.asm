...
.0:     LD DE,$3800-$0400       ; H ten¡a bit 5 puesto
        ADD HL,DE
        LD A,L
        rst $08
        POP HL
...
checa_pausa:
    ...
    if programador=1
        ...
        cp $0c          ; 3 - Energ¡a
        jp z,truquitos_3
        cp $02          ; 4 - Siguiente mapa
        jp z,truquitos_4
        cp $03          ; 5 - Siguiente habitaci¢n
        jp z,truquitos_5
        cp $0e          ; 6 - Beso
        jp z,truquitos_6
    endif
...
caminable:
        ...
        ;
        ; Rutina para reproducci¢n de sonido PCM
        ; HL = Apunta a flujo de sonido
        ; DE = N£mero de bytes
        ;
sonido_pcm:
        halt
        ld bc,$c201     ; Desactiva interrupciones
        call WRTVDP
        call psg_silencio
        ld a,$80
        out (PSG),a
        ...
        out (PSG),a
        ;
        ; 3.579545 mhz =    279.4 ns. = ciclo T
        ; 8.000000 khz = 125000.0 ns. = 447 ciclos
        ;
.0:     ld a,(hl)       ; 7
        rrca            ; 4
        rrca            ; 4
...
.2:     djnz .2         ; 13/
        ...
        or e            ; 4
        jp nz,.0        ; 10
        ld bc,$e201     ; Reactiva interrupciones
        jp WRTVDP
...
depura:         RB 1    ; Trucos de depuraci¢n
