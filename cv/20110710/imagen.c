...
** Revisi¢n: 01-jul-2011. Permite cambiar el color para archivos sin compactar.
** Revisi¢n: 05-jul-2011. Permite alternar bitmap y color en compactados.
*/
...
int main(int argc, char *argv[])
{
  ...
  */
  if (argc < 3) {
    ...
    printf("Crea imagen descompactada: (hace caso a cambio color arg. c)\n");
    printf("  imagen archivo.bmp salida.dat a b c d e\n");
    printf("Crea imagen compactada color intercalado:\n");
    printf("  imagen archivo.bmp salida.dat a b c d e f\n");
    printf("\n");
    exit(1);
  }
    ...
    for (d = 0; d < tam_x; d++) {
      ...
      if (argc == 7) {
        ...
        */
        ...
        if (e == 1 && argc != 5)
          e = 0;
        else if (argc == 6 || argc >= 8) {  /* ¨Traslado de color? */
          ap1 = argv[5];
          while (*ap1 && ap1[1]) {
            g = toupper(*ap1) - '0';
            if (g > 9)
  ...
  */
  ...
  } else if (argc == 9) {  /* Bitmap/color alternado */
    for (c = 0; c < tam_y; c += 8) {
