        ...
        ; Revisi¢n: 14-may-2011. C¢digo de depuraci¢n para explorar mapas.
        ;
...
PROGRAMADOR:    EQU 0
        ...
        ;
        ; Total libre: 111 bytes de 32K (0.3%)
        ;
...
;        DB $AA,$55      ; Reconoce cartucho y muestra pantalla Coleco
    ...
    if programador=1
        DB 255 and ($81+$fd+$35+$07) 
    else
        DB $81          ; Byte para ajustar el resultado del checksum a cero
    endif
...
.6:     LD A,(HL)               ; 7
        ...
        NOP                     ; 4
        DEC C                   ; 4
        DJNZ .6                 ; 13 = 34 ciclos antes de OUT
        LD A,C
        EXX
        LD C,A
        DJNZ .7
...
VISUAL_LETRA2:
        ...
        SRL H
        RR L
        LD DE,$3c00-$0400       ; H ten¡a bit 5 puesto
        ADD HL,DE
        LD A,L
        rst $08
        POP HL
...
.3:
        rst $20 ; lee_bit
        jr z,.4 ; 0 = sin cambios con respecto a la habitaci¢n en limpio
        rst $20 ; lee_bit
        rst $20 ; lee_bit
        ex af,af'
        and 3
