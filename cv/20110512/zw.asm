        ...
        ;
        ; Defina esto para activar funciones de depuraci¢n del programador
        ; No usado actualmente.
        ;
PROGRAMADOR:    EQU 1

        ;
        ; Definir esto para poner mi logo
        ;
MI_LOGO:        EQU 1
        ...
        ;
        ; Total libre: 0 bytes de 32K (0.0%)
        ;
...
;        DB $55,$AA      ; Reconoce cartucho y entra inmediato
        ...
        DB $a5          ; Byte para ajustar el resultado del checksum a cero
