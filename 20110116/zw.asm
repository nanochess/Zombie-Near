...
maneja_dir:
        ...
        ld (hl),a       ; Posici¢n Y.
        inc hl
        ld (hl),$10     ; Sprite, andando a la izquierda
        inc hl
        ld de,$0101
        jp .11
...
.14:    inc hl
        ...
        ld (hl),a       ; Ultimo movimiento
        inc hl
        ld a,$01        ; !!! Jefe zombie que echa carrera
        ld a,$21        ; !!! Chica zombie, carrera
        ld a,$43        ; !!! Zombie malevolo que brinca y corre
        ld a,$00        ; Jefe zombie normal que brinca
        ld (hl),a
        inc hl
        inc hl
        inc hl
