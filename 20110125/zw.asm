        ...
        ; $00000 - C¢digo y datos b sicos            2.50K
        ...
        ; $10000 - Historia y mosaicos               2.12K
        ; $12000 - Inician im genes compactadas.       -
        ; $1E000 - Libre                             8.00K
        ; $20000 - Final del ROM.
        ;                              Total libre: 15.11K de 128K
        ;
...
.4:     ld c,5          ; Desplazamiento sprite bala
        cp 8
        jp z,.8
        ld c,4          ; Desplazamiento sprite explosi¢n bala
        cp 9
        jp z,.8
