...
LINEAR: EQU 1
        ...
        ;
        ; Total libre: 1063 bytes de 64K (1.6% libre)
        ;
...
GRAFICA_COPYRIGHT:      ; El copyright
    ...
    ENDIF
        ...
        ;   ddmmaa
        DB "120411"     ; Reservado por MSX, aprovecho para la revisi¢n
...
LINEAS11:
        ...
        ld b,32                 ; 32 bytes (una l¡nea de pixels)
