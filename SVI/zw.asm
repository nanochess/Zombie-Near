        ...
        ;
        ; (c) Copyright Oscar Toledo Guti‚rrez 2011-2015
        ;
        ...
        ; Revisi¢n: 26-ene-2015. Admite los 2 joysticks del Spectravideo.
        ;
...
PROGRAMADOR:    EQU 0
        ...
        ;
        ; Mapa de uso del ROM:
        ; $0000-$7FFF - Programa, mapas, gr ficas y sonido
        ;
        ; Total libre: 524 bytes de 32K (1.6%)
        ;              

        FNAME "ZOMBNEAR.ROM"
        ORG $0000,$7fff

VDP:    equ $80                      ; Puerta del VDP
PSG:    equ $88                      ; Chip de sonido
KEYSEL: equ $96                      ; Selecci¢n del teclado
KEY1:   equ $99                      ; Byte 1 de teclado
...
vector_nmi:
        ...
        ;
        in a,(VDP+5)    ; Leer este registro reinicia latches de dir. VDP
        call vector_int
        pop hl
        pop de
        pop bc
...
modes:
	...
	dw	mode6
        ...
        ;
sprites_bin:    incbin "sprites.bin.plet5"
sprites_heroes: equ $C000
sprites_jefes:  equ $C000+$98*8
