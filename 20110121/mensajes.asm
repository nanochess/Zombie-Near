...
historia_28b:
        ...
        ; TENGO QUE / ALIMENTAR / MIS GATOS
        db $14,$05,$0e,$07,$0f,$00,$11,$15,$05,$fe
        db $01,$0c,$09,$0d,$05,$0e,$14,$01,$12,$fe
...
mensaje_1:
        ...
        db $13,$05,$00,$08,$01,$fe
        db $12,$0f,$14,$0f,$00,$0c,$01,$fe        
...
mensaje_4:
        ...
        db $0e,$0f,$17,$2E                      ; NOW!
        db $FF
        ; LLAME AL / EQUIPO / TACTICO / ­AHORA!
        db $0c,$0c,$01,$0d,$05,$00,$01,$0c,$fe
        db $05,$11,$15,$09,$10,$0f,$fe
        db $14,$01,$03,$14,$09,$03,$0f,$fe
        db $37,$01,$08,$0f,$12,$01,$2e,$ff
