        ...
        ; Revisi¢n: 25-ene-2011. Correcci¢n en avance_historia, borraba lema
        ;                        final. Trae las gr ficas de mosaico de slot.
        ;                        Los monitos de final ya son bicolor. La
        ;                        estatua de jugador 1 ahora est  en otra
        ;                        ubicaci¢n.
        ; Revisi¢n: 26-ene-2011. Correcci¢n en monitos de final, el sprite
        ;                        bicolor estaba mal puesto.
        ; Revisi¢n: 06-feb-2011. Se incrementa retardo de presentaci¢n a 15
        ;                        segundos.
        ; Revisi¢n: 08-feb-2011. Se optimiza entrada_retrato.
        ; Revisi¢n: 15-feb-2011. Se reduce retardo de presentaci¢n a 12 seg.
        ;                        Ajustes en llamada a actualiza_indicadores.
        ;                        Si ha ganado el juego y se oprime F5 muestra
        ;                        fotos de los desarrolladores (yo y Ad n)
        ;
...
.1:     halt
        ...
        halt
        call pantalla_negra
        LD HL,GRAFICA_OSCAR and $ffff
        LD DE,GRAFICA_OSCAR>>16
        LD B,4
        CALL CARGAR_TOMA
        call musica_triunfo
        call retardo_cuadro
        ...
        call retardo_cuadro      
        call retardo_cuadro
        ld a,3          ; Para bug en MSKISS
        ld (SLOT3),a
        call musica_general
        LD HL,GRAFICA_ADAN and $ffff
        LD DE,GRAFICA_ADAN>>16
        LD B,4
        CALL CARGAR_TOMA
        call retardo_cuadro      
        call retardo_cuadro      
