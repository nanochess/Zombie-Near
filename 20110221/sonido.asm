        ...
        ; Revisi¢n: 26-ene-2011. Correcci¢n al genera m£sica con acorde, el
        ;                        silencio estaba mal.
        ; Revisi¢n: 06-feb-2011. Se actualiza el efecto de berrido del
        ;                        megamonstruo, casi no se escuchaba y se hace
        ;                        diferente para la chica.
        ; Revisi¢n: 10-feb-2011. Se cambia volumen canal 1 melod¡a principal,
        ;                        casi no se escuchaba por efecto en bajo en
        ;                        melod¡a principal. Ajustes en bajo para
        ;                        melod¡as arm¢nicas. Recorte efecto berrido.
        ;                        Nuevas funciones efecto_pierde y
        ;                        genera_pierde.
        ;
