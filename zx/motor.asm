        ...
        ;
        ; Creaci¢n: 01-ago-2011. Revisi¢n 3
        ;
...
_0:     ld (hl),0
        ...
        jp nz,_0
        ;
        ; Inicia tabla de color 32x24 a color gris con fondo negro
        ;
        ld bc,$0300
_1:     ld (hl),$07
        inc hl
        ...
        jp nz,_1
        ;
        ; Tabla precalculada para correr un byte por hasta 7 bits a la der.
        ;
        ld hl,$6000
        ld bc,$0800
_4:     push bc
...
_6:     ld (hl),a
        ...
        djnz _4
        ;
        ; Tabla precalculada para posici¢n Y de pixel en pantalla
        ;
        ld hl,$7000
        ld bc,$c000
_8:     ld a,c
...
_1:     ld e,(hl)
        ...
        ;
        ; Dibuja un byte corrido por hasta 7 pixeles
        ;
    MACRO PIXEL_BYTE
        ld a,(de)
        ld c,a
