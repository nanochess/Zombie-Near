...
graf_bitmap:
        ...
        db $00,$03,$0f,$1f,$33,$23,$61,$79      ; Reusado (53,0)
        db $00,$c0,$f0,$f8,$cc,$c4,$86,$9e      ; Reusado (53,1)
        ; 03 - Pared este
        db $57,$55,$75,$55,$55,$5d,$55,$d5
        db $1f,$11,$11,$11,$f1,$11,$11,$11
        db $7f,$7f,$3e,$3c,$1c,$0f,$03,$00      ; Reusado (53,2)
        db $fe,$7e,$3c,$1c,$18,$f0,$c0,$00      ; Reusado (53,3)
        ; 04 - Pared sur
