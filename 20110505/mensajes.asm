        ...
        ; Revisi¢n: 14-abr-2011. Se agrega el di logo del beso.
        ; Revisi¢n: 15-abr-2011. Se cambia 'YO TE AMO' por 'TE AMO'.
        ; Revisi¢n: 02-may-2011. Nuevo mensaje_20
        ; Revisi¢n: 04-may-2011. Cambio 'THEM'RE' a 'THEY'RE'.
        ;
...
mensaje_13:     ; I'VE BEEN / THINKING / ABOUT US
        ...
        db $08,$05,$00,$05,$13,$14,$01,$04,$4f
        db $10,$05,$0e,$13,$01,$0e,$04,$4f
        db $05,$0e,$00,$14,$89
...
mensaje_14:     ; WHAT ARE YOU / TRYING TO / SAY?
        ...
        db $35,$11,$15,$05,$00,$09,$0e,$14,$05,$0e,$14,$01,$53
        db $04,$05,$03,$09,$12,$0d,$05,$af

mensaje_15:     ; WE SURVIVED
        db $17,$05,$00,$13,$15,$12,$16,$09,$16,$05,$84
        ; SOBREVIVIMOS
        db $13,$0f,$02,$12,$05,$16,$09,$16,$09,$0d,$0f,$93

mensaje_16:     ; SO?
        db $13,$0f,$af
        ; ¨ENTONCES?
        db $35,$05,$0e,$14,$0f,$0e,$03,$05,$13,$af

mensaje_17:     ; I LOVE YOU
        db $09,$00,$0c,$0f,$16,$05,$00,$19,$0f,$95
        ; TE AMO
        db $14,$05,$00,$01,$0d,$8f

mensaje_18:     ; I ---
        db $09,$00,$34,$34,$b4
        ; YO ---
        db $19,$0f,$00,$34,$34,$b4

mensaje_19:     ; DON'T SPEAK
        db $04,$0f,$0e,$30,$14,$00,$13,$10,$05,$01,$8b
        ; NO HABLES
        db $0e,$0f,$00,$08,$01,$02,$0c,$05,$93

    if programador=0
mensaje_20:     ; A GAME BY
        db $00,$01,$00,$07,$01,$0d,$05,$00,$02,$99
        ; UN JUEGO DE
        db $15,$0e,$00,$0a,$15,$05,$07,$0f,$00,$04,$85
    endif
